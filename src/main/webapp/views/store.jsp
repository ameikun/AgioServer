    ...
    <div class="header-top">
        ...
        <div class="top-nav">
            ...
            <ul>
                ...
                <li><a href="../views/mainpage.jsp" class="scroll" data-hover="AiZGo主页">AiZGo主页</a></li>
                <li><a href="../views/contact.jsp" class="scroll" data-hover="联系我们">联系我们</a></li>
            </ul>
            <!--script-->
            <script>
        ...
        <div class="container">
            <div class="about-bottom">
                <div class="col-sm-7 our-mission">
                    <h3>加入AiZGo</h3>
                    <form role="form" action="/AgioServer/store/addStore" method="post" class="">
                        <div class="">
                            <p>店铺名称</p>
                            <input class="form-control" placeholder="店铺名称" name="shopName" type="text" id="shopName">
                            <p>店铺地址</p>
                            <input class="form-control" placeholder="店铺地址" name="shopAddress" type="text" id="shopAddress">
                            <p>营业开始时间</p>
                            ...
                            <br>
                            <button id="btn-addstore" type="submit" style="font-size: 1.3em;background:#6CB6B6;padding: 0.6em 1.7em;text-align: center;color: #fff;border: none;
...
<script src="/AgioServer/resources/store/js/store.js"></script>
</body>
</html>
